...
import { FaMapMarkerAlt, FaPhoneAlt, FaEnvelope, FaClock, FaGlobe, FaPaperPlane } from "react-icons/fa";
...
// New styled components for email input form
...
const EmailInput = styled.input.attrs({ type: "email", placeholder: "Enter your email" })`
  flex: 1;
  padding: 14px 20px;
  font-size: 1.1rem;
  ...
  &:focus {
    ...
    box-shadow: 0 0 8px ${({ theme }) => theme.accent1};
  }
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    if (email.trim() !== "") {
      setSubmitted(true);
      setEmail("");
      // Optional: add notification or toast here
    }
  };
      ...
      <Container>
        ...
        <ContactInfo>
          ...
          <EmailForm onSubmit={handleSubmit}>
            ...
            />
            <SubmitButton type="submit" aria-label="Submit email">
              Submit <FaPaperPlane />
            </SubmitButton>
          </EmailForm>
          ...
          <List>
            <ListItem>
              <FaEnvelope />
              <a href="mailto:contact@yourblog.com">contact@blogScope.com</a>
            </ListItem>
            <ListItem>
              <FaEnvelope />
              <a href="mailto:support@yourblog.com">support@blogScope.com</a>
            </ListItem>
          </List>
          ...
          {submitted && <p style={{ color: "green", marginTop: "12px" }}>Thank you for subscribing!</p>}
        </ContactInfo>
